...
from comet_ml.config.config_init import _init as init_api_key, init_onprem
from comet_ml.logging_messages import COMET_INIT_API_KEY_DEPRECATED
...
def init(parsed_args, remaining):
    if parsed_args.api_key:
        LOGGER.warning(COMET_INIT_API_KEY_DEPRECATED)
