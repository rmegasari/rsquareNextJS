    ...
    <section className="py-24 dark:bg-gray-900">
      <div className="container mx-auto px-6 space-y-16">
        {FEATURES.map((feature, index) => {
          ...
          const content = (
            <div className="w-full md:w-5/12 space-y-3" data-animate-on-scroll>
              <h3 className="font-bold text-xl mb-2 text-gray-800 dark:text-gray-100">{feature.title}</h3>
              <p className="text-gray-600 dark:text-gray-300">{feature.description}</p>
            </div>
          );
          const image = (
            <div className="hidden md:block md:w-5/12" data-animate-on-scroll>
              <Image
                src={feature.image}
                alt={feature.title}
                width={480}
          ...
          return (
            <div className="relative mb-16" key={feature.title}>
